    ...
    <ul>
      {seriesNames.length > 0 ? (
        seriesNames.map((aSeries) => (
          <li className="border-style flex flex-row text-app-white last-of-type:mb-0" key={aSeries}>
            ...
            <div className="w-full">
              ...
              <ul className="border-style border-t bg-neutral-800">
                {seriesGroup[aSeries].map((post) => (
                  <li className="border-style last-of-type:border-n flex gap-8 border-b px-8 py-6" key={post.meta.title}>

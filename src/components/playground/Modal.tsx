...
export default function ModalPage() {
  ...
  const examples = [
    {
      title: 'Direct Modal',
      description: '페이지 렌더링시 모달을 즉시 노출 시킬 수 있습니다.',
      icon: '🪟',
    ...
    },
    {
      ...
      component: (closeModal: () => void) => (
        <div className="rounded-lg bg-white p-8 text-black">
          ...
          <p className="mb-4 text-gray-600">
            기본적인 모달 컴포넌트입니다. 중앙 정렬과 딤 배경이 적용되며, 스크롤
            잠금 기능을 제공합니다.
          </p>
          <button
            type="button"
          ...
          <div className="flex items-start gap-2 sm:gap-3">
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-3 w-full">
                <Syntax
                  language="tsx"
                  children={`import { Modal } from '@lani.ground/react-modal';
import '@lani.ground/react-modal/css';
            ...
            >
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <Modal
                  ...
                  centerMode
                  containerPadding="20px"
                  disabledOutsideClose={example.title === 'Advanced Modal'}
                />

          ...
          <div className="flex items-start gap-2 sm:gap-3">
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-3 w-full">
                <Syntax
                  language="tsx"
                  children={`import { ImageViewerProvider } from '@lani.ground/react-image-viewer';
import '@lani.ground/react-image-viewer/css';
          ...
          <div className="flex items-start gap-2 sm:gap-3">
            ...
            <div className="min-w-0 space-y-2 sm:space-y-3">
              ...
              <div className="space-y-1 text-xs text-gray-300 sm:space-y-2 sm:text-sm">
                ...
                <p>
                  • <strong>이동:</strong> 이미지를 드래그하여 원하는 부분을 볼
                  수 있습니다
                </p>
                <p>
                  • <strong>갤러리 모드:</strong> 같은 ImageViewerProvider 안의
                  모든 이미지가 연결됩니다
                </p>
              </div>
            </div>

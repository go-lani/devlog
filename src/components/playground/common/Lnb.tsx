...
export default function Lnb() {
  ...
  return (
    <div className="lg:border-style relative lg:sticky">
      <div
        className={`w-full bg-neutral-900 ${shareTechMono.className} mb-4 space-y-4 text-xl`}
      >
        <Link
          href="/playground"
          className="flex items-center rounded-xl border border-neutral-700/50 bg-gradient-to-br from-neutral-800/30 to-neutral-900/50 p-4 backdrop-blur-sm"
        >
        ...
        <Link
          href="/"
          className="flex items-center rounded-xl border border-neutral-700/50 bg-gradient-to-br from-neutral-800/30 to-neutral-900/50 p-4 backdrop-blur-sm transition-all duration-200 hover:border-neutral-600/50"
        >
